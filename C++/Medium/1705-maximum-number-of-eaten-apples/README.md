<h2><a href="https://leetcode.com/quest/data-structures-and-algorithms-quest/quiz/maximum-number-of-eaten-apples/?envType=problem-list-v2&envId=dsa-sequence-valley-assignment-i">1705. Maximum Number of Eaten Apples</a></h2><h3>Medium</h3><hr><p>There is a special kind of apple tree that grows apples every day for <code>n</code> days. On the <code>i<sup>th</sup></code> day, the tree grows <code>apples[i]</code> apples that will rot after <code>days[i]</code> days, that is on day <code>i + days[i]</code> the apples will be rotten and cannot be eaten. On some days, the apple tree does not grow any apples, which are denoted by <code>apples[i] == 0</code> and <code>days[i] == 0</code>.</p>
